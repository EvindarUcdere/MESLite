...
async function main() {
  ...
  assert(morning.producedQuantity === 350, `Morning shift produced quantity must be 350, found ${morning.producedQuantity}`);
  assert(morning.scrapQuantity === 1, `Morning shift scrap quantity must be 1, found ${morning.scrapQuantity}`);
  assert(evening.producedQuantity === 357, `Evening shift produced quantity must be 357, found ${evening.producedQuantity}`);
  assert(evening.scrapQuantity === 5, `Evening shift scrap quantity must be 5, found ${evening.scrapQuantity}`);
